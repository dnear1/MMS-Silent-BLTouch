...
//
  ...
  #define X_MIN_PIN           3  //-1
  #define X_MAX_PIN          -1 //3
  #define Y_MIN_PIN          14 //-1
  #define Y_MAX_PIN          -1 // 14
#else
  #define X_MIN_PIN           3
  #define X_MAX_PIN          -1
  #define Y_MIN_PIN          14
  ...
  #define Z_MAX_PIN          18
#else
  #define Z_MIN_PIN          19 // was 18  swapped because I'm using Zmax instead of zmin DN 2020-05-29
  #define Z_MAX_PIN          18  //was 19 
#endif
